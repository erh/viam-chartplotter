...
void main() {
  ...
  test('shipped defaults keep both tiers off until B1/B2 land', () {
    // vectorTileNavaidMinZ / vectorTileStructureMinZ default to null, so every
    // zoom gets the overview render — mobile has no vector layers to take over
    // the stripped features yet.
    for (var z = 7; z <= 16; z++) {
